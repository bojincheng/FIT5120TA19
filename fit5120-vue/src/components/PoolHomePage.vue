<template>
      ...
      <div class="section-heading">
        ...
        <div class="section-tagline-container">
          <p class="section-tagline">
            Drowning is a leading cause of accidental death for toddlers <br>in Australia, with backyard pools being a <span class="toddler-stat-trigger" @mouseover="showToddlerStat = true" @mouseleave="showToddlerStat = false">major risk factor</span>.
          </p>
          
          <!-- Toddler stat popup with absolute positioning -->
          <div class="toddler-stat-popup" :class="{ 'visible': showToddlerStat }">
            <svg class="hand-drawn-arrow" viewBox="0 0 100 150" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
              <!-- Main arrow path from major risk factor to stat box -->
              <path d="M90,10 C70,50 40,90 10,120" stroke="#e74c3c" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="5,5" />
              <!-- Arrow tip -->
              <path d="M15,105 L10,120 L25,110" stroke="#e74c3c" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
            <div class="toddler-stat-content">
              <span class="stat-percentage">{{ poolDrowningStats.age0to4Percentage }}%</span>
              <span class="stat-description">of drowning deaths in children aged 0-4 occur in swimming pools</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="sandy-content-section">
      ...
      <div class="section-heading">
        <span class="section-label">Pool Safety Essentials</span>
        <h2 class="section-title">Key Steps to a Safer Pool</h2>
              </div>
            ...
            <div class="safety-content">
              ...
              <div class="safety-stat-container">
                <div class="stat-row">
                  ...
                  <p class="safety-stat-text">of toddler drownings occur in pools with non-compliant fencing.</p>
          </div>
        </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        isScrolled: false,
        // Toddler stat hover state
        showToddlerStat: false,
    ...
    created() {
      ...
      // Set values based on correct statistics from DrowningSearch data
      const validatedStats = this.validatePoolDrowningStatistics();
      this.poolDrowningStats.age0to4Percentage = validatedStats.age0to4Percentage;
      this.poolDrowningStats.age5to14Percentage = validatedStats.age5to14Percentage;
    },
      mounted() {
...
.stat-description {
  ...
  /* Ensure content is properly centered and scaled within the wider container */
  display: flex;
  justify-content: center;
}
